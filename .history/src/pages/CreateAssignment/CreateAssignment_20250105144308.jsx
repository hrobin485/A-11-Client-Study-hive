...
const CreateAssignment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Assignment created successfully:', result);  // Log result
      alert(result.message || 'Assignment created successfully!');
      navigate('/Assignments'); // Redirect to assignments page
    } catch (error) {
      console.error('Error creating assignment:', error);  // Log the error
