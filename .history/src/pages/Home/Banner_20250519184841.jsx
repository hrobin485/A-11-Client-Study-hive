      ...
      <div className="hero-content flex-col-reverse lg:flex-row-reverse lg:ml-14">
        ...
        <div className="flex-1">
          ...
          <p className="py-6">
            ...
            and teamwork among students and learners of all ages. The core focus
            is to enable collaboration, facilitate assignment completion, and
            foster personal and academic growth in a community‑driven
            environment.
          </p>
