...
const TestimonialsSection = () => {
  return (
    <section className="testimonials-section dark:bg-gray-900">
      <h2 className="testimonials-title">What Our Users Say</h2>
      <p className="testimonials-subtitle">Real feedback from real learners around the world.</p>
      <div className="testimonials-grid">
        {testimonials.map((user, index) => (
          <div key={index} className="testimonial-card dark:bg-gray-800 dark:text-white">
