  ...
  return (
    <section className="unique-section dark:bg-gray-800">
      <div className="unique-text ">
        <h2 className="unique-title  dark:text-gray-100">What Makes StudyHive Unique?</h2>
        <p className="unique-description  dark:text-gray-100">
        ...
        <ul className="unique-points  dark:text-gray-100">
          <li className='dark:text-gray-100'>🧠 Learn with your peers in real time</li>
          <li className='dark:text-gray-100'>📅 Plan and complete assignments together</li>
          <li className='dark:text-gray-100'>💬 Give and receive helpful feedback</li>
          <li className='dark:text-gray-100'>📊 Monitor team progress effectively</li>
        </ul>
      </div>
