...
const Banner = () => {
    return ( 
        ...
        <div className="hero bg-base-200 min-h-96 mt-5 rounded-xl dark:bg-gray-800  dark:text-gray-100">
            <div className="lg:ml-20 hero-content flex-col lg:flex-row-reverse">
                <div className='flex-1 -ml-16 md:-ml-10 lg:ml-16'>
                    <motion.img
                        src={team2}
                        animate={{ y: [50, 100, 50] }}
                    ...
                    <motion.img
                        ...
                        className="max-w-sm w-64 rounded-t-[40px] rounded-br-[40px] border-l-4 border-b-4 border-blue-400 shadow-2xl -ml-20 md:-ml-20 lg:ml-20" />
                </div>
