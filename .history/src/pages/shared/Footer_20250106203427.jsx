...
const Footer = () => {
    return (
        <footer className=" bg-white pt-10 dark:bg-gray-800" >
          <div className="text-center  dark:text-gray-100 ">
          <h1 className="text-4xl font-bold mb-3">Study Hive</h1>
          <p className='text-blue-400  dark:text-gray-100'>StudyHive is an innovative online platform designed to enhance group study experiences, helping students <br/> collaborate, organize, and track their learning efficiently. </p>
          </div>
          <div className="divider mx-20 mt-6"></div>
       <div className="footer text-blue-400 p-10 dark:text-gray-100 ">
       <nav>
