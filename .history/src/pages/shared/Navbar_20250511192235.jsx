        ...
        <div className="navbar bg-slate-300 dark:bg-gray-900 text-black dark:text-white rounded-lg">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow  dark:bg-gray-800 dark:text-gray-100">
                        {links}
                    </ul>
                </div>
            ...
            <div className="navbar-end">
                {
                    user ? (
                        <div className="flex items-center gap-4 relative group">
                            ...
                            <button onClick={handleSignOut} className="btn  dark:bg-gray-800 dark:text-gray-100">Sign out</button>
                        </div>
                    ) : (
                        <>
                            <Link to="/register">Register</Link>
                            <Link to="/signIn">
                                <button className="btn dark:bg-gray-800 dark:text-gray-100">Sign In</button>
                            </Link>
                        </>
                    )
                }
