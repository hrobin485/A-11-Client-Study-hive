...
const Navbar = ({ toggleTheme, theme }) => {
    ...
    return (
        <div className={`navbar bg-slate-300 rounded-lg ${theme === 'dark' ? 'bg-gray-800 text-white' : ''}`}>
            ...
            <div className="navbar-end">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute left-0 w-48 bg-gray-700 text-white text-xs rounded px-2 py-1 mt-2 hidden group-hover:block">
                                    <ul>
                                        ...
                                        <li><NavLink to="/MyAttemptedAssignment" className="block px-2 py-1 hover:bg-gray-600">My Attempted Assignments</NavLink></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <button onClick={toggleTheme} className="ml-4 btn btn-sm">
